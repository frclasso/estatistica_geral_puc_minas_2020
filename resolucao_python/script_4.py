...
if __name__ == "__main__":
    ...
    print(f"Tempo de compra: {calculo.calcula_posicao(percentil_10)} segundos.")
    print('-'* 30)

    percentil_20 = calculo.calcula_percentil(20)
    print(f'Percentil arredondado: {percentil_20}')
    print(f"Tempo de compra: {calculo.calcula_posicao(percentil_20)} segundos.")
    print()